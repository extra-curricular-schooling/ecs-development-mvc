...
{
    class BusinessCrawler : IBaseCrawler
    {
        private HashSet<string> Tags = new HashSet<string> { "credit","economics","business","money","finances" };
            ...
            foreach (var art in links)
            {
                try
                {
                    ...
                    if (tagMatch)
                    {
                        ...
                        {
                            articleType = "Business & Economics",
                            articleTitle = title,
                            articleLink = art[0],
        ...
        {
            Sites.Add(new KeyValuePair<string, List<string>>("https://brokemillennial.com/", new List<string> { "div", "class", "featuredimg", "a", "href", "https://brokemillennial.com", "meta", "property", "og:description", "content", "meta", "property", "og:title", "content", "meta", "property", "og:description", "content" }));
            Sites.Add(new KeyValuePair<string, List<string>>("https://www.huffingtonpost.com/section/business", new List<string> { "div", "class", "card__content", "a", "href", "https://www.huffingtonpost.com", "meta", "name", "news_keywords", "content", "meta", "property", "og:title", "content", "meta", "property", "og:description", "content" }));
