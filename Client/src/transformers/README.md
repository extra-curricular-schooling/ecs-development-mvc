###The transformers are used to "transform" incoming requests into the proper naming conventions that you want.

```
# From petervmeijgaard's boilerplate repository
/* ============
 * Transformer
 * ============
 *
